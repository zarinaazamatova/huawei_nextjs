const Logo = () => {
    return (
        ...
        viewBox="0 0 1221.56 146.52">
            <defs>
                <clipPath id="clip-path" transform="translate(-51.01 -42.95)">
                    <rect className="cls-1" x="51.01" y="42.95" width="1221.55" height="146.52"/>
                    </clipPath>
                    <clipPath id="clip-path-2" transform="translate(-51.01 -42.95)">
                        <rect className="cls-1" x="51.01" y="42.95" width="1221.56" height="146.52"/>
                        </clipPath>
                        </defs>
                        <g className="cls-2">
                            <g className="cls-3">
